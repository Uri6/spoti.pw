...
parser.add_argument("--model", type=Path, required=True, help="AOT .aimodelc directory for the target architecture")
...
if model.suffix != ".aimodelc" or not model.is_dir():
    parser.error("--model must be an AOT .aimodelc directory")
...
shutil.copyfile(here.parent.parent / "tweak/Sources/Shared/Sing/SGStemSeparator.swift", out / "SGStemSeparator.swift")
shutil.copytree(model, assets / "separator.aimodelc")
for name in ("golden_raw.f32", "golden_vocals.f32"):
...
{ archiveVersion = 1; classes = {}; objectVersion = 56; objects = {
 ...
 A00000000000000000000003 = {isa = PBXGroup; children = (A00000000000000000000007,A00000000000000000000008,A00000000000000000000009,A0000000000000000000000A,); sourceTree = "<group>";};
 ...
 A0000000000000000000000C = {isa = PBXSourcesBuildPhase; buildActionMask = 2147483647; files = (A0000000000000000000000E,A0000000000000000000000F,); runOnlyForDeploymentPostprocessing = 0;};
